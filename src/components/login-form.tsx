  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
          ...
          <form className="p-6 md:p-8" onSubmit={handleSubmit}>
            <FieldGroup>
              ...
              <FieldDescription className="text-center">
                Only email/password is enabled right now. Need an account?{" "}
          ...
          <div className="relative hidden border-l border-border/70 bg-muted/45 p-8 md:flex md:flex-col md:justify-between">
            ...
            <div className="relative space-y-3">
              ...
              <h2 className="max-w-xs text-lg leading-tight font-semibold">
                Root traffic is resolved by the active Convex session.
              </h2>
            </div>
            <div className="relative space-y-3 text-xs leading-6 text-muted-foreground">
              <p>Authenticated users are redirected to `/:tenantSlug/issue`.</p>
              <p>Unauthenticated users are redirected to `/login`.</p>
              <p>
                This screen uses the existing form component as the password
                provider UI.
              </p>
            </div>
          </div>
      ...
      <FieldDescription className="px-6 text-center">
        By continuing, you agree to the project&apos;s authentication flow and
