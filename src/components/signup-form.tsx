  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
        ...
        <CardContent className="grid p-0 md:grid-cols-[1.05fr_0.95fr]">
            ...
            <FieldGroup>
              <div className="flex flex-col items-center gap-2 text-center">
                ...
                <p className="text-sm text-balance text-muted-foreground">
                  This signs the user up through the Convex password provider
                  and creates the first tenant workspace.
                </p>
              </div>
              <Field>
                ...
                />
                <FieldDescription>
                  Stored in the default Convex Auth `users` table.
                </FieldDescription>
              </Field>
              <Field>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    />
                    <span className="text-xs text-muted-foreground">
                      Local preview only. File storage is not wired yet.
                    </span>
                  </div>
                </div>
              </Field>
              <Field>
                ...
                />
                <FieldDescription>
                  The backend normalizes this to trimmed lowercase.
                </FieldDescription>
              </Field>
              <Field>
                ...
                <FieldDescription>
                  Convex Auth requires at least 8 characters by default.
                </FieldDescription>
              </Field>
          ...
          <div className="relative hidden border-l border-border/70 bg-muted/45 p-8 md:flex md:flex-col md:justify-between">
            ...
            <div className="relative space-y-3">
              ...
              <h2 className="max-w-xs text-lg leading-tight font-semibold">
                New accounts are created directly in Convex Auth.
              </h2>
            </div>
            <div className="relative space-y-3 text-xs leading-6 text-muted-foreground">
              <p>The signup form posts `name`, `email`, and `password`.</p>
              <p>
                Successful sign-up creates the auth session and bootstraps a
                tenant named after the user.
              </p>
              <p>
                The avatar control is retained from your component and stays as
                a local preview.
              </p>
            </div>
          </div>
      ...
      <FieldDescription className="px-6 text-center">
        By creating an account, you agree to the project&apos;s authentication
        flow and session routing rules.
      </FieldDescription>
    </div>
  )
}
